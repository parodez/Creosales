...
// Query to get the number of clients per sector
...
// Query to get the count of clients by evaluation result
                ...
                <div class="chart-box wide elegant">
                    ...
                    <div class="chart-content responsive-row">
                        ...
                        <div class="sector-count">
                            ...
                            <?php foreach ($clientData as $sector): ?>
                                <div class="sector-item sector-<?php echo strtolower($sector['sector_name']); ?>">
                                    <span><?php echo $sector['sector_name']; ?>: <?php echo $sector['client_count']; ?> <?php echo $sector['client_count'] == 1 ? 'client' : 'clients'; ?></span>
                                </div>
                            <?php endforeach; ?>
                        </div>
                    </div>
            ...
            if (ctxPie) {
                pieChart = new Chart(ctxPie, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            data: [
                                <?php echo $clientData[0]['client_count']; ?>,
                                <?php echo $clientData[1]['client_count']; ?>,
                                <?php echo $clientData[2]['client_count']; ?>,
                                <?php echo $clientData[3]['client_count']; ?>
                            ],
                            backgroundColor: [
                                sectorColors["School"],
                                sectorColors["Government"],
