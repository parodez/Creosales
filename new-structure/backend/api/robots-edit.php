...
if (!isset($_POST['robots_id'], $_POST['robots_item'], $_POST['robots_desc'], $_POST['robots_cost'], $_POST['robots_srp'])) {
    $success = false;
    $message = 'Missing fields';
} else {
    $productManager = new ProductManager($pdo, new CacheManager());
    $data = $productManager->editRobot($_POST['robots_id'], $_POST['robots_item'], $_POST['robots_desc'], $_POST['robots_cost'], $_POST['robots_srp']);
    if (!$data['success']) {
        $success = false;
